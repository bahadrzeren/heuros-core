...
public class SsimParser {
	...
	private static Logger logger = Logger.getLogger(SsimParser.class);

	/**
	 * Parses the SSIM file end returns the leg list.
	 * 
	 * @param ssimFile File to parse.
	 * @return List of legs.
	 */
	public List<Leg> parseSSIM(File ssimFile) {
		try {
			...
			logger.error("SSIM file read exception!", ex);
			return null;
		}
	}
