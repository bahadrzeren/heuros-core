...
public class PairGenerator implements Processor<DutyView, Pair> {

	private static Logger logger = Logger.getLogger(PairGenerator.class);

	private int hbNdx = -1;

	public PairGenerator(int hbNdx) {
		this.hbNdx = hbNdx;
	}
	...
	public PairGenerator setDutyRepository(DataRepository<Duty> dutyRepository) {
		this.duties = dutyRepository.getModels();
		return this;
	}

	public PairGenerator setHbNdx(int hbNdx) {
		this.hbNdx = hbNdx;
		return this;
	}
